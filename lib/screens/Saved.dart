...
class _MyStatefulWidgetState extends State<Saved>{
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, i){
              ...
              return Dismissible(
                ...
                child: Container( margin: const EdgeInsets.only(bottom: 8), child: SelectableStoreItem(store: item) ),
                ...
                onDismissed: (direction){
                  setState(() { stores.removeAt(i); });
                  Scaffold.of(context).showSnackBar(SnackBar(content: Text("Store has been Removed")));
                },
              );
            },
          ),
...
class _SelectableStoreItem extends State<SelectableStoreItem> with RestorationMixin {
  ...
  void onSelected(){
    setState(() { isSelected.value = !isSelected.value;});
  }
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text( store.description, style: descriptionStyle.copyWith(color: Colors.black54) ),
                ),
                Text("${store.category}"),
                Row(
